/********************************************************************
	created:	2015/07/02  14:23
	file base:	WL_UILayer
	file ext:	cs
	author:		xx
...
[AddComponentMenu("XLCWGame/UI/UILayer")]
public class WL_UILayer : MonoBehaviour {

    public enum Layer
    {
        //该枚举跟Unity的Prefab紧密关联，只能顺序添加，不能插入;  2014.09.02
        //有层次添加需求，可找咨询
        MultiLayer,         //血条层
        MainBarLayer,       //主界面层
    ...
    //[HideInInspector]
    [SerializeField]
    protected Layer uiLayer = Layer.MultiLayer;
    ...
    public int GetLayerbase()
    {
        switch (uiLayer)
        {
            case Layer.MultiLayer:
                mLayerbase = (int)RealLayer.MultiLayer;
                break;
