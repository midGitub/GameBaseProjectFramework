...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.EndModule();
		L.BeginModule("Best");
		Best_ResourceMgrWrap.Register(L);
		Best_AssetBundleInfoWrap.Register(L);
		Best_LuaDestroyBundleWrap.Register(L);
		L.RegFunction("SceneLoadedCallback", Best_SceneLoadedCallback);
		L.BeginModule("AssetBundleInfo");
		L.RegFunction("LoadAssetCompleteHandler", Best_AssetBundleInfo_LoadAssetCompleteHandler);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int Best_SceneLoadedCallback(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(Best.SceneLoadedCallback), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(Best.SceneLoadedCallback), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int Best_AssetBundleInfo_LoadAssetCompleteHandler(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(Best.AssetBundleInfo.LoadAssetCompleteHandler), func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateFactory.CreateDelegate(typeof(Best.AssetBundleInfo.LoadAssetCompleteHandler), func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
