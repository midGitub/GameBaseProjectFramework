...
public class Util : MonoBehaviour {
    ...
    //public static MemoryStream CompressBytesExt(MemoryStream source)
    //{
    //    MemoryStream output = MemoryStreamPool.MainThreadMsPool.New();
    //   //UnityEngine.Debug.Log("MemoryStreamPool.MainThreadMsPool.New 13");
    //   ms2.Position = 0;
    //   ms2.SetLength(0);
    //   deflaterInputStream.Reset();
    //   deflaterInputStream.Write(source.GetBuffer(), 0, (int)source.Length);
    //   output.Write(ms2.GetBuffer(), 0, (int)ms2.Length);
    //   //MemoryStreamPool.MainThreadMsPool.Delete(source); // MemoryStreamPool 回收
    //   return output;
    //}
    ...
    //public static MemoryStream DecompressBytesExt(MemoryStream source)
    //{
    //    MemoryStream resBuffer = null;
    //    InflaterInputStream sm = inflaterInputStream;
    //    sm.Reset();
    //    ms1.Position = 0;
    //    ms1.SetLength(0);
    //    ms1.Write(source.GetBuffer(), 0, (int)source.Length);
    //    ms1.Position = 0;
    //    MemoryStream output = MemoryStreamPool.MainThreadMsPool.New();
    //    //UnityEngine.Debug.Log("MemoryStreamPool.MainThreadMsPool.New 14");
    //    while (sm.Available == 1)
    //    {
    //        int nByteLen = sm.Read(s_DecompressBuffer, 0, s_DecompressBuffer.Length);
    //        output.Write(s_DecompressBuffer, 0, nByteLen);
    //    }
    //    output.Seek(0, SeekOrigin.Begin);
    //    resBuffer = MemoryStreamPool.MainThreadMsPool.New();
    //    //UnityEngine.Debug.Log("MemoryStreamPool.MainThreadMsPool.New 15");
    //    resBuffer.Write(output.GetBuffer(), 0, (int)output.Length);

        
    //    MemoryStreamPool.MainThreadMsPool.Delete(output); // MemoryStreamPool回收
    //    return resBuffer;
    //}
...
//            return path + "CC_Lua/" + name;
//        }

//        Debugger.Log("LuaPath: " + path + "CC_Lua/" + name + ".lua");
//        return path + "CC_Lua/" + name + ".lua";
//    }
